...
//  SwiftUICrypto
//
//  Created by Ike Chukz on 6/1/23.
//
...
/*
 ...
 
 {
   ...
   "sentiment_votes_up_percentage": 71.36,
   "sentiment_votes_down_percentage": 28.64,
   "watchlist_portfolio_users": 1297414,
   "market_cap_rank": 1,
   "coingecko_rank": 1,
   ...
   "status_updates": [],
   "last_updated": "2023-06-02T03:01:22.563Z"
 }
...
//
//   let CoinDetailModel = try? JSONDecoder().decode(CoinDetailModel.self, from: jsonData)
